    ...
    return (
      <div className="relative inline-block w-full">
        <label htmlFor="pallet-select-compact" className="sr-only">
          Select from all 20 Pallet Products
        </label>
        <div className="relative flex items-center">
          ...
          >
            <option value="" disabled>
              📦 Select from all 20 Pallet Products ({PRODUCTS.length} Available)...
            </option>
            {PRODUCTS.map((p) => (
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Browse our complete verified inventory of 20 liquidation pallets from one dropdown
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-lg relative">
            <label htmlFor="catalog-pallet-select" className="sr-only">
              Jump to any of the 20 Pallet Products
            </label>
            <div className="relative">
              ...
              >
                <option value="">
                  ▾ Click here to choose from all 20 Pallet Products...
                </option>
                {PRODUCTS.map((prod) => (
  ...
  return (
    <div ref={dropdownRef} className="relative">
      <button
        ...
        title="View All 20 Liquidation Pallet Products"
      >
        <Package className={`w-4 h-4 ${isOpen ? 'text-slate-950' : 'text-emerald-400'}`} />
        <span className="tracking-tight">All 20 Pallet Products</span>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="p-2.5 bg-slate-900/90 border-b border-slate-800">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Filter the 20 pallets by name, brand, or #..."
          ...
          {/* Scrollable list of all 20 products */}
          ...
          <div className="p-2.5 bg-slate-950 border-t border-slate-800 text-[11px] text-slate-400 flex items-center justify-between">
            <span className="flex items-center gap-1 text-slate-300">
              ...
              All 20 lots include European 24-Month Warranty
            </span>
            <button
              onClick={() => {
                setIsOpen(false);
